...
<div id="wrapper" style="min-height: 911px;">
	...
	<section id="wrtie" class="container">
		<div class="page-title">상호 검색</div>
		<div class="wrtieContents">
			<div class="wr-wrap line label200 _toggleSection">
				...
				<div class="wr-list">
					<div class="wr-list-label">상호명 입력</div>
					<div class="wr-list-con">
						<input type="text" name="branchName" value="" class="span200" onkeyup="pressSearch();" placeholder="상호명을 입력하세요."><a href="#" onclick="clickSearch()" class="btn black ml5">검색</a>
					</div>
				</div>
			</div>
			<div class="btnSet">
