...
<div id="em-mypick" style="width:100%;max-width:760px;margin:0 auto;font-family:'NanumSquareRound', sans-serif;font-size:14px;font-weight:400;color:#2B353F;line-height:1.5em;">
	...
	<div id="container" style="padding:25px 30px 50px 30px;word-break:keep-all;">
		...
		<div style="margin-top:40px;text-align:center;">
			<span class="icon-01" style="display:inline-block;width:57px;height:57px;background:url('https://sh1.bizcc.co.kr/em/img/icon_01.png');"></span>
			<p style="font-size:1.2em;margin-top:5px;font-weight:600;">This is the email approval number. <span style="color:#4386F7">{{ $details['code'] }}</span></p>
			<p style="font-size:1.35em;margin-top:30px;font-weight:600;"></p>
		</div>
